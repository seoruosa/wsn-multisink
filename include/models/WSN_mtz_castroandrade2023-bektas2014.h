...
class WSN_mtz_castro_andrade_2023_bektas2014 : public WSN
{
...
WSN_mtz_castro_andrade_2023_bektas2014::WSN_mtz_castro_andrade_2023_bektas2014(WSN_data &instance) : WSN(instance, "MTZ-castro2023-bektas"),
...
void WSN_mtz_castro_andrade_2023_bektas2014::set_params_cplex(IloCplex &cplex)
{
    WSN::set_params_cplex(cplex);
    // cplex.setParam(IloCplex::Param::Benders::Strategy, 3);
}

void WSN_mtz_castro_andrade_2023_bektas2014::add_objective_function()
{
...
void WSN_mtz_castro_andrade_2023_bektas2014::add_mtz_model_variables()
{
    T.setName("T");
...
void WSN_mtz_castro_andrade_2023_bektas2014::add_subtour_constraints()
{
    for (int i = 0; i < instance.n; i++)
    {
...
void WSN_mtz_castro_andrade_2023_bektas2014::add_in_coming_edge_mtz_constraints()
{
    // Constraints 4
    IloExpr expr(env);
...
void WSN_mtz_castro_andrade_2023_bektas2014::add_calculate_weight_tree_constraints()
{
    IloExpr expr(env);
...
void WSN_mtz_castro_andrade_2023_bektas2014::add_lower_bound_weight_constraints()
{
    IloExpr expr(env);
...
void WSN_mtz_castro_andrade_2023_bektas2014::add_leaf_constraints()
{
    for (int i = 0; i < instance.n; i++)
    {
...
double WSN_mtz_castro_andrade_2023_bektas2014::calculates_big_M()
{
    double M_weight = 1.0;
...
void WSN_mtz_castro_andrade_2023_bektas2014::add_bektas2014_constraints()
{
    int n = instance.n;
...
inline void WSN_mtz_castro_andrade_2023_bektas2014::add_adasme2023_valid_inequalities()
{
