...
class WSN_flow_model_0 : public WSN
{
public:
    WSN_flow_model_0(WSN_data &instance);
...
WSN_flow_model_0::WSN_flow_model_0(WSN_data &instance) : WSN(instance, "FlowModel0"),
...
void WSN_flow_model_0::set_params_cplex(IloCplex &cplex)
{
    WSN::set_params_cplex(cplex);
    cplex.setParam(IloCplex::Param::Benders::Strategy, 3);
}

void WSN_flow_model_0::build_model()
{
...
void WSN_flow_model_0::add_objective_function()
{
...
void WSN_flow_model_0::add_flow_model_variables()
{
    // Naming variables
    T.setName("T");
    for (int i = 0; i < instance.n; i++)
...
void WSN_flow_model_0::add_flow_limit_constraints()
{
    IloExpr expr(env);
...
void WSN_flow_model_0::add_flow_conservation_constraints()
{
    IloExpr expr(env);
...
void WSN_flow_model_0::add_extra_node_constraints()
{
    // exp 9
    IloExpr expr(env);
    for (int i = 0; i < instance.n; i++)
...
void WSN_flow_model_0::add_calculate_weight_tree_constraints()
{
    // exp 15
    for (int i = 0; i < instance.n; i++)
    {
...
void WSN_flow_model_0::add_lower_bound_constraints()
{
    // exp 20
    IloExpr expr(env);
    for (int i = 0; i < instance.n; i++)
...
void WSN_flow_model_0::add_leaf_constraints()
{
    for (int i = 0; i < instance.n; i++)
    {
...
void WSN_flow_model_0::add_CastroAndrade2023_valid_inequalities()
{
    for (int i = 0; i < instance.n; i++)
    {
...
double WSN_flow_model_0::calculates_big_M()
{
    double M_weight = 1.0;
