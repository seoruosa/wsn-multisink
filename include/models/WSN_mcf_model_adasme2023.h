...
class WSN_mcf_model_adasme2023 : public WSN
{
public:
...
WSN_mcf_model_adasme2023::WSN_mcf_model_adasme2023(WSN_data &instance) : WSN(instance, "MCF-Model-adasme2023"),
...
void WSN_mcf_model_adasme2023::set_params_cplex(IloCplex &cplex)
{
    WSN::set_params_cplex(cplex);
    // cplex.setParam(IloCplex::Param::Benders::Strategy, 3);
}

inline void WSN_mcf_model_adasme2023::add_objective_function()
{
...
inline void WSN_mcf_model_adasme2023::add_flow_model_variables()
{
    T.setName("T");
...
inline void WSN_mcf_model_adasme2023::add_ahani2019_mcf_constraints()
{
    IloExpr expr(env);
...
inline void WSN_mcf_model_adasme2023::add_connect_sink_assignment_constraints()
{
    IloExpr expr_x(env);
    IloExpr expr_y(env);
    IloExpr expr_z(env);
...
inline void WSN_mcf_model_adasme2023::add_CastroAndrade2023_valid_inequalities()
{
...
inline void WSN_mcf_model_adasme2023::add_adasme2023_valid_inequalities()
{
...
void WSN_mcf_model_adasme2023::add_mcf_valid_inequalities()
{
...
inline IloModel WSN_mcf_model_adasme2023::create_relaxed()
{
...
void WSN_mcf_model_adasme2023::print_full(IloCplex &cplex, std::ostream &cout)
{
