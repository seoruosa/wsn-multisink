...
class WSN_mcf_model_adasme2023 : public WSN_mcf_model_base
{
public:
...
WSN_mcf_model_adasme2023::WSN_mcf_model_adasme2023(WSN_data &instance) : WSN_mcf_model_base(instance)
{
