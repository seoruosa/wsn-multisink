...
void WSN_flow_model_3_base::set_params_cplex(IloCplex &cplex)
{
    WSN::set_params_cplex(cplex);
    // cplex.setParam(IloCplex::Param::Benders::Strategy, 3);
}

void WSN_flow_model_3_base::build_model()
{
...
void WSN_flow_model_3_base::add_objective_function()
{
...
void WSN_flow_model_3_base::add_flow_model_variables()
{
    // Naming variables
    T.setName("T");
...
void WSN_flow_model_3_base::add_flow_limit_constraints()
{
...
void WSN_flow_model_3_base::add_flow_conservation_constraints()
{
    IloExpr expr(env);
...
void WSN_flow_model_3_base::add_extra_node_constraints()
{
    // exp 9
    IloExpr expr(env);
    for (int k = 0; k < instance.number_trees; k++)
...
void WSN_flow_model_3_base::add_lower_bound_constraints()
{
    // exp 20
    IloExpr expr(env);
    for (int i = 0; i < instance.n; i++)
...
void WSN_flow_model_3_base::add_leaf_constraints()
{
    for (int i = 0; i < instance.n; i++)
    {
...
void WSN_flow_model_3_base::add_CastroAndrade2023_valid_inequalities()
{
    IloExpr expr(env);
    for (int i = 0; i < instance.n; i++)
    {
...
inline void WSN_flow_model_3_base::add_adasme2023_valid_inequalities()
{
...
double WSN_flow_model_3_base::calculates_big_M()
{
    double M_weight = 1.0;
...
void WSN_flow_model_3_base::print_full(IloCplex &cplex, std::ostream &cout)
{
