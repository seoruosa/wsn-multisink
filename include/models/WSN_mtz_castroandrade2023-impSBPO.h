...
class WSN_mtz_castro_andrade_2023_imp_sbpo : public WSN
{
...
public:
    WSN_mtz_castro_andrade_2023_imp_sbpo(WSN_data &instance);
    // ~WSN_mtz_model_2();
...
WSN_mtz_castro_andrade_2023_imp_sbpo::WSN_mtz_castro_andrade_2023_imp_sbpo(WSN_data &instance) : WSN(instance, "MTZ-sbpo-orig"),
...
void WSN_mtz_castro_andrade_2023_imp_sbpo::build_model()
{
    ...
    add_castrodeAndrade2023_constraints(true); // Const CA2023 -> 12, 15, 16, 17, 10 (true: implementação 
    //                                                                              no SBPO, false: atual),
    //                                                             18, 19, 20, 21, 22, 23
...
void WSN_mtz_castro_andrade_2023_imp_sbpo::set_params_cplex(IloCplex &cplex)
{
    WSN::set_params_cplex(cplex);
    // cplex.setParam(IloCplex::Param::Benders::Strategy, 3);
}

void WSN_mtz_castro_andrade_2023_imp_sbpo::add_objective_function()
{
...
void WSN_mtz_castro_andrade_2023_imp_sbpo::add_mtz_model_variables()
{
    T.setName("T");
...
void WSN_mtz_castro_andrade_2023_imp_sbpo::add_subtour_constraints()
{
    for (int i = 0; i < instance.n; i++)
    {
...
void WSN_mtz_castro_andrade_2023_imp_sbpo::add_in_coming_edge_mtz_constraints()
{
    // Constraints 4
    IloExpr expr(env);
...
void WSN_mtz_castro_andrade_2023_imp_sbpo::add_calculate_weight_tree_constraints()
{
    IloExpr expr(env);
...
void WSN_mtz_castro_andrade_2023_imp_sbpo::add_lower_bound_weight_constraints()
{
    IloExpr expr(env);
...
void WSN_mtz_castro_andrade_2023_imp_sbpo::add_leaf_constraints()
{
    for (int i = 0; i < instance.n; i++)
    {
...
double WSN_mtz_castro_andrade_2023_imp_sbpo::calculates_big_M()
{
    double M_weight = 1.0;
...
void WSN_mtz_castro_andrade_2023_imp_sbpo::add_bektas2014_constraints()
{
    int n = instance.n;
...
void WSN_mtz_castro_andrade_2023_imp_sbpo::add_castrodeAndrade2023_constraints(bool SBPO_IMPLEMENTATION_CONSTRAINT_10)
{
...
inline void WSN_mtz_castro_andrade_2023_imp_sbpo::add_adasme2023_valid_inequalities()
{
