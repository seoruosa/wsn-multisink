...
class WSN_flow_model_3_des : public WSN_flow_model_3_base
{
private:
...
WSN_flow_model_3_des::WSN_flow_model_3_des(WSN_data &instance) : WSN_flow_model_3_base(instance)
{
    WSN::formulation_name = "FlowModel3-des";
}
