...
class WSN_mcf_model_weight_on_node_benders : public WSN
{
public:
    WSN_mcf_model_weight_on_node_benders(WSN_data &instance);
...
WSN_mcf_model_weight_on_node_benders::WSN_mcf_model_weight_on_node_benders(WSN_data &instance) : WSN(instance, "MCF-Model-weight-node-benders"),
...
inline void WSN_mcf_model_weight_on_node_benders::build_model()
{
    // basic model
...
void WSN_mcf_model_weight_on_node_benders::set_params_cplex(IloCplex &cplex)
{
    WSN::set_params_cplex(cplex);
    cplex.setParam(IloCplex::Param::Benders::Strategy, 3);
}

inline void WSN_mcf_model_weight_on_node_benders::add_objective_function()
{
...
inline void WSN_mcf_model_weight_on_node_benders::add_flow_model_variables()
{
    T.setName("T");
...
inline void WSN_mcf_model_weight_on_node_benders::add_ahani2019_mcf_constraints()
{
    IloExpr expr(env);
...
inline void WSN_mcf_model_weight_on_node_benders::add_connect_sink_assignment_constraints()
{
    IloExpr expr_x(env);
    IloExpr expr_y(env);
    IloExpr expr_z(env);
...
inline void WSN_mcf_model_weight_on_node_benders::add_CastroAndrade2023_valid_inequalities()
{
...
inline void WSN_mcf_model_weight_on_node_benders::add_adasme2023_valid_inequalities()
{
...
void WSN_mcf_model_weight_on_node_benders::add_mcf_valid_inequalities()
{
...
inline void WSN_mcf_model_weight_on_node_benders::add_calculate_weight_tree_constraints()
{
    IloExpr expr(env);
...
inline IloModel WSN_mcf_model_weight_on_node_benders::create_relaxed()
{
...
void WSN_mcf_model_weight_on_node_benders::print_full(IloCplex &cplex, std::ostream &cout)
{
...
inline double WSN_mcf_model_weight_on_node_benders::calculates_big_M()
{
    double M_weight = 1.0;
