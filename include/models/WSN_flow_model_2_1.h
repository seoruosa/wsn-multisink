...
class WSN_flow_model_2_1 : public WSN
{
...
WSN_flow_model_2_1::WSN_flow_model_2_1(WSN_data &instance) : WSN(instance, "FlowModel2-1"),
...
void WSN_flow_model_2_1::set_params_cplex(IloCplex &cplex)
{
    WSN::set_params_cplex(cplex);
    // cplex.setParam(IloCplex::Param::Benders::Strategy, 3);
}

void WSN_flow_model_2_1::build_model()
{
...
void WSN_flow_model_2_1::add_objective_function()
{
...
void WSN_flow_model_2_1::add_flow_model_variables()
{
    // Naming variables
    T.setName("T");
    for (int i = 0; i < instance.n; i++)
...
void WSN_flow_model_2_1::add_flow_limit_constraints()
{
...
void WSN_flow_model_2_1::add_flow_conservation_constraints()
{
    IloExpr expr(env);
...
void WSN_flow_model_2_1::add_extra_node_constraints()
{
    // exp 9
    IloExpr expr(env);
    for (int k = 0; k < instance.number_trees; k++)
...
void WSN_flow_model_2_1::add_lower_bound_constraints()
{
    // exp 20
    IloExpr expr(env);
    for (int i = 0; i < instance.n; i++)
...
void WSN_flow_model_2_1::add_leaf_constraints()
{
    for (int i = 0; i < instance.n; i++)
    {
...
void WSN_flow_model_2_1::add_CastroAndrade2023_valid_inequalities()
{
    IloExpr expr(env);
    for (int i = 0; i < instance.n; i++)
    {
...
inline void WSN_flow_model_2_1::add_adasme2023_valid_inequalities()
{
...
void WSN_flow_model_2_1::add_bektas2020_node_current_constraints()
{
    // for (int k = 0; k < instance.number_trees; k++)
    // {
...
void WSN_flow_model_2_1::add_arc_depot_assignment_constraints()
{
    for (int k = 0; k < instance.number_trees; k++)
    {
        for (int i = 0; i < instance.n; i++)
...
double WSN_flow_model_2_1::calculates_big_M()
{
    double M_weight = 1.0;
...
inline IloModel WSN_flow_model_2_1::create_relaxed()
{
...
void WSN_flow_model_2_1::print_full(IloCplex &cplex, std::ostream &cout)
{
