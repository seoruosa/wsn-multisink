...
class WSN_mcf_model : public WSN
{
public:
...
WSN_mcf_model::WSN_mcf_model(WSN_data &instance) : WSN(instance, "MCF-Model"),
...
inline void WSN_mcf_model::add_objective_function()
{
...
inline void WSN_mcf_model::add_flow_model_variables()
{
    T.setName("T");
...
inline void WSN_mcf_model::add_ahani2019_mcf_constraints()
{
    IloExpr expr(env);
...
inline void WSN_mcf_model::add_connect_sink_assignment_constraints()
{
    IloExpr expr_x(env);
    IloExpr expr_y(env);
    IloExpr expr_z(env);
...
inline void WSN_mcf_model::add_CastroAndrade2023_valid_inequalities()
{
...
inline void WSN_mcf_model::add_adasme2023_valid_inequalities()
{
...
void WSN_mcf_model::add_mcf_valid_inequalities()
{
...
inline IloModel WSN_mcf_model::create_relaxed()
{
...
void WSN_mcf_model::print_full(IloCplex &cplex, std::ostream &cout)
{
